        ...
        <div className="flex items-center flex-shrink-0 text-white mr-4">
          <Link className="flex items-center flex-row" to={"/"}>
            <img
              ...
              alt=""
            />
            <span className="font-semibold text-xl tracking-tight">COMDEE</span>
          </Link>
        </div>
        <div className="w-full ml-4 block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            <NavLink
              to={"/"}
              className={({ isActive }) =>
                isActive
                  ? "block mt-4 lg:inline-block lg:mt-0 text-red-500 hover:text-red-700 mr-4"
          ...
          <div>
            {user ? (
              <div className="flex items-center px-2 rounded-full  text-white font-semibold hover:text-black hover:bg-white mt-4 lg:mt-0">
                ...
                {isOpen && (
                  <div className="absolute mt-4 rounded-md right-[23px] border top-10 bg-white shadow-md">
                    <Link
                      to={"/user/history"}
